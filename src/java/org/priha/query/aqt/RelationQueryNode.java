...
public class RelationQueryNode extends NAryQueryNode implements QueryConstants {
     ...
     */
    public static final QName STAR_NAME_TEST = new QName(RepositoryManager.NS_PRIHA, "__star__");
    ...
    public QName getProperty() {
        return relPath == null ? null : relPath.getLastComponent();
...
//        }
     ...
     */
    public void addPathElement(QName element) {
        if (relPath != null) {
            relPath = relPath.resolve(element);
        }
        else
        {
