...
import org.priha.query.aqt.QueryNodeFactory;
import org.priha.query.aqt.QueryRootNode;
import org.priha.query.aqt.QueryTreeBuilder;
...
public class QueryBuilder implements QueryTreeBuilder {
     ...
     * @inheritDoc
     */
    public String toString(QueryRootNode root, NamespaceMapper resolver)
            throws InvalidQueryException {
