...
public class CassandraProviderTest extends AbstractTest
{
    SessionImpl m_session;
    static EmbeddedCassandraService cassandra = null;
    
    public void setUp() throws Exception
    {
        super.setUp();
        
        System.setProperty("storage-config", "tests/etc");
        ...
        RepositoryImpl rep = RepositoryManager.getRepository("cassandranocache.properties");
    ...
    {
        return new TestSuite( CassandraProviderTest.class );
    }

    /**
     *  Simple embedded cassandra service
     */
